        ...
        private suspend fun populateDatabase(database: AppDatabase) {
            ...
            if (existingSubjects.isEmpty()) {
                ...
                val questions = listOf(
                    Question(1, 1, "What type of reaction is: 2H₂ + O₂ → 2H₂O?", "Decomposition", "Combination", "Displacement", "Double Displacement", "Combination", "Two or more reactants combine to form a single product in a combination reaction."),
                    Question(2, 1, "Which gas is released during the reaction of zinc with hydrochloric acid?", "Oxygen", "Nitrogen", "Hydrogen", "Carbon Dioxide", "Hydrogen", "Zn + 2HCl → ZnCl₂ + H₂. Hydrogen gas is evolved."),
                    Question(3, 1, "What is the color of ferrous sulphate crystals?", "Blue", "Green", "White", "Yellow", "Green", "Ferrous sulphate (FeSO₄) crystals are green in color."),
                    ...
                    Question(23, 16, "Which of the following is an irrational number?", "√4", "√9", "√2", "22/7", "√2", "√2 cannot be expressed as a ratio of two integers."),
                    ...
                    Question(25, 16, "If LCM(a, b) = 36 and HCF(a, b) = 6, then a × b = ?", "36", "216", "18", "42", "216", "LCM × HCF = Product of numbers, so 36 × 6 = 216."),
                    ...
                    Question(27, 17, "The zeroes of x² - 5x + 6 are:", "2, 3", "1, 6", "-2, -3", "-1, -6", "2, 3", "Factoring: (x-2)(x-3) = 0, so x = 2 or x = 3."),
                    Question(28, 17, "Sum of zeroes of 2x² + 3x - 5 is:", "-3/2", "3/2", "-5/2", "5/2", "-3/2", "Sum of zeroes = -b/a = -3/2."),
                    Question(29, 17, "If one zero of x² - 4x + k is 2, then k = ?", "2", "4", "6", "8", "4", "Substituting x=2: 4 - 8 + k = 0, so k = 4."),
                    ...
                    Question(32, 21, "In similar triangles, the ratio of areas equals the square of the ratio of:", "Altitudes", "Corresponding sides", "Medians", "All of these", "Corresponding sides", "Area ratio = (side ratio)² for similar triangles."),
                    Question(33, 21, "Pythagoras theorem is applicable in:", "Any triangle", "Right-angled triangle", "Isosceles triangle", "Equilateral triangle", "Right-angled triangle", "a² + b² = c² holds only for right-angled triangles."),
                    Question(34, 21, "If ΔABC ~ ΔDEF and AB/DE = 2/3, then ar(ABC)/ar(DEF) = ?", "2/3", "4/9", "3/2", "9/4", "4/9", "Ratio of areas = (ratio of sides)² = (2/3)² = 4/9."),
                    ...
                    Question(46, 23, "The value of sin 30° is:", "1", "1/2", "√3/2", "0", "1/2", "sin 30° = 1/2 is a standard trigonometric value."),
                    Question(47, 23, "If sin θ = 3/5, then cos θ = ?", "4/5", "3/4", "5/3", "5/4", "4/5", "Using sin²θ + cos²θ = 1, cos θ = √(1 - 9/25) = 4/5."),
                    Question(48, 23, "tan 45° equals:", "0", "1", "√3", "1/√3", "1", "tan 45° = sin 45°/cos 45° = 1."),
                    Question(49, 23, "Which identity is correct?", "sin²θ + cos²θ = 1", "sin²θ - cos²θ = 1", "tan²θ + sec²θ = 1", "cot²θ - cosec²θ = 1", "sin²θ + cos²θ = 1", "This is the fundamental Pythagorean trigonometric identity."),
                    Question(50, 23, "The value of cos 0° is:", "0", "1", "-1", "1/2", "1", "cos 0° = 1 as the adjacent side equals the hypotenuse at 0°.")
                )
